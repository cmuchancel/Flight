...
class Environment:
    ...
    def calculate_buoyant_force(self, projectile):
        ...
        buoyant_force = - self.calculate_air_density(projectile.pos.y)  * volume * acceleration_gravity
    ...
    def calculate_dimensionless_rotation_rate(self, projectile):
        ...
        Re_ohm = ( mag(projectile.angular_velocity) * reference_length **2 ) / (gamma_kinematic_viscosity)
