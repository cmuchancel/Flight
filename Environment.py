...
class Environment:
    ...
    def calculate_force_gravity(self, projectile): # Textbook MMU Page 49
        height = projectile.pos.y
        return ((self.G * self.earth_mass * projectile.mass) / (self.earth_radius + height) ** 2) * vector(0, -1, 0)
    
    def calculate_torque_gravity(self, projectile): # Textbook MMU Page 368
    ...
    @staticmethod
    def calculate_dynamic_viscosity_coefficient(): # Air Viscosity Nasa
    ...
    # Lift forces on solid spherical particles in unbounded flows Page 2 Nomenclature
    ...
    def calculate_lift_coefficient(self,projectile):
        ...
        if re_p >= 200: # Lift forces on solid spherical particles in unbounded flows Page 7
...
#Experiments on the lift of a spinning sphere in a range of intermediate Reynolds numbers Page 1
...
#Lift forces on solid spherical particles in unbounded flows Page 7
    ...
    #Lift forces on solid spherical particles in unbounded flows Page 3
